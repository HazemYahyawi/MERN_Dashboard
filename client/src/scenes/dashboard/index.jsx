...
const Dashboard = () => {
  ...
  return (
    <Box m="1.5rem 2.5rem">
      <FlexBetween>
        <Header title="DASHBOARD" subtitle="Bio market your dashboard" />
        <Box>
          {/* <Button
            sx={{
      ...
      >
        ...
        <StatBox
          title="Total Pistachio collaborations"
          value={PistachioCollabs && PistachioCollabs.length}
          increase="+5%"
          description="Since last month"
          icon={
            <Groups2
        ...
        />
        <StatBox
          title="Total almond collaborations"
          value={AlmondCollabs && AlmondCollabs.length}
          increase="+43%"
          description="Since last month"
          icon={
            <Groups
